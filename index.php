...
<html lang="en">
<head>
<title>Centro de animales Lost &amp; Found</title>
<meta charset="utf-8">
...
<!-- header -->
		<header>
			<div class="wrapper">
				<h1><a href="index.php" id="logo">Centro de animales Lost &amp; Found</a></h1>
				<nav>
					<ul id="top_nav">
				...
				<nav>
					<ul id="menu">
						...
						<li><a href="mission.php">Nuestra Mision</a></li>
						<li><a href="news.php">Noticias varias</a></li>
						<li><a href="help.php">Como ayudar</a></li>
				...
				<div class="box1">
					<div class="line1"><div class="line2 wrapper">
						...
						<section class="col1 pad_left1">
							...
							This website template has several pages:<a href="index.php" class="link1">Home</a>,<a href="mission.php" class="link1">Our Mission</a>,<a href="news.php" class="link1">News and Press</a>,<a href="help.php" class="link1">How to Help</a>,<a href="contact.php" class="link1">Contact Us</a>.<a href="#" class="button1 color3">Read More</a>
						</section>
					</div></div>
				</div>	
			</div>
...
<!-- footer -->
		<footer>
			<div class="wrapper">
				<a href="index.php" id="footer_logo"><span>Hope</span>Center</a>
				<ul id="icons">
			...
			<div class="wrapper">
				<nav>
					<ul id="footer_menu">
						...
						<li><a href="news.php">Noticias varias</a></li>
						<li><a href="help.php">Como ayudar</a></li>
						<li class="end"><a href="contact.php">Contactenos</a></li>
					</ul>
				</nav>
