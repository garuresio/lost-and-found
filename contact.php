			...
			<div class="wrapper">
				...
				<nav>
					<ul id="menu">
						...
						<li id="menu_active"><a href="contact.php">Contactenos</a></li>
					</ul>
				</nav>
			</div>
		</header>
				...
				<div class="box1">
					<div class="line1 wrapper">
						<section class="col1">
							...
							+354 5635600<br>
							+354 5635610<br>
							<a href="mailto:">BM080189@alumno.udb.edu.sv</a>
						</section>
			...
			<div class="wrapper">
				<nav>
					<ul id="footer_menu">
						...
						<li><a href="news.php">Noticias varias</a></li>
						<li><a href="help.php">Como ayudar</a></li>
						<li class="end active"><a href="contact.php">Contactenos</a></li>
					</ul>
				</nav>
